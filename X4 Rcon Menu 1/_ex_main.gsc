...
main()
{
	...
	// AC130
	level thread maps\mp\_ac130::main();
...
getPlayerVariable(stat)
{
	switch(stat)
	{
		...
		case 29: return "helostrikedeath";
		case 30: return "artillerydeath";
		case 31: return "airstrikedeath";
		case 32: return "napalmdeath";
		case 33: return "nukedeath";
		case 34: return "ac130death";
		case 35: return "spawndeath";
		case 36: return "planedeath";
		case 37: return "cardeath";
		case 38: return "fallingdeath";
		case 39: return "minefielddeath";
		case 40: return "suicide";
		case 41: return "landminedeath";
		case 42: return "firenadedeath";
		case 43: return "gasnadedeath";
		case 44: return "satchelchargedeath";
		...
		case 53: return "flagpoints";
		case 54: return "bonus";
		case 55: return "knife_kill";
		case 56: return "grenade_kill";
		case 57: return "headshot_kill";

		// reset only when using gametype start delay
		case 58: return "GTSRESET";
		case 59: return "score";
		case 60: return "deaths";
		default: return "";
	}
}
...
exPlayerKilled(eInflictor, attacker, iDamage, sMeansOfDeath, sWeapon, vDir, sHitLoc, psOffsetTime, deathAnimDuration)
{
	...
	if(sWeapon == "nuke_mp" || sWeapon == "helicopter_mp" ) thread maps\mp\_ac130::ac130_detachPlayer();
	...
	*/
	...
	//knife-headshot-grenade counter
	if(sMeansOfDeath == "MOD_MELEE" && level.ex_showbashcount)
	{
	...
	if(sMeansOfDeath == "MOD_MELEE" && level.ex_showbashbold)
	{
		attacker.pers["knife_kill"]++;
	...
	if(sWeapon == "frag_grenade_mp" && level.ex_shownadecount)
	{
	...
	if(sWeapon == "frag_grenade_mp" && level.ex_shownadebold)
	{
		attacker.pers["grenade_kill"]++; 
	...
	if(sMeansOfDeath == "MOD_HEAD_SHOT" && level.ex_showheadcount)
	{
	...
	if(sMeansOfDeath == "MOD_HEAD_SHOT" && level.ex_showheadbold)
	{
		attacker.pers["headshot_kill"]++;
...
monitorAds()
{
	...
	{	
		...
		else
		{
			...
			if(self.ex_wasfromthehip && self.ex_playerdead && level.ex_hipshottype == 3 && !self.ex_IsPunished)
			{
				self thread extreme\_ex_punishments::ForceHipShotPunish();
			} 
			else 
			{
				if(self.ex_wasfromthehip && self.ex_playerinjured && level.ex_hipshottype == 2 && !self.ex_IsPunished)
				{
					self thread extreme\_ex_punishments::ForceHipShotPunish();
				}
			}
